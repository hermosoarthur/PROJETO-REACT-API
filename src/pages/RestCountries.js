...
//       console.log('País selecionado:', randomCountry.name);
      
//       const countryData = {
//         name: randomCountry.name || 'N/A',
//         capital: randomCountry.capital || 'N/A',
//         flag: randomCountry.flags?.png || randomCountry.flag || '',
//         population: randomCountry.population ? randomCountry.population.toLocaleString('pt-BR') : 'N/A',
//         region: randomCountry.region || 'N/A',
//         area: randomCountry.area ? `${randomCountry.area.toLocaleString('pt-BR')} km²` : 'N/A'
//       };
...
//                   onError={(e) => {
//                     e.target.src = 'https://via.placeholder.com/320x240?text=Bandeira+Não+Disponível';
//                   }}
//                 />
//               </div>
